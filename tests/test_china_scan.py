...
class ChinaScanFilterTest(unittest.TestCase):
    ...
    def test_common_chinese_platform_salary_ranges_are_monthly(self):
        ...
        self.assertEqual(CHINA_SCAN.monthly_salary_floor_k("25-35K，餐补30元/天"), 25)
        self.assertAlmostEqual(CHINA_SCAN.monthly_salary_floor_k("800-1000元/天"), 17.4)
        self.assertIsNone(CHINA_SCAN.monthly_salary_floor_k("餐补30元/天"))
        self.assertAlmostEqual(
            CHINA_SCAN.monthly_salary_floor_k("日薪1000元/天，餐补30-50元/天"),
            21.75,
        )
        self.assertAlmostEqual(
            CHINA_SCAN.monthly_salary_floor_k("日薪1000元/天，住房补贴2-3K/月"),
            21.75,
        )
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(
            CHINA_SCAN.monthly_salary_floor_k("日薪1000元/天，2-3K/月住房补贴"),
            21.75,
        )
        self.assertEqual(CHINA_SCAN.monthly_salary_floor_k("月薪25-35K/月含住房补贴"), 25)
        self.assertAlmostEqual(
            CHINA_SCAN.monthly_salary_floor_k("日薪1000元/天，绩效奖金2-3K/月"),
            21.75,
        )
        self.assertAlmostEqual(
            CHINA_SCAN.monthly_salary_floor_k("日薪1000元/天，2-3K/月绩效奖金"),
            21.75,
        )
        self.assertEqual(CHINA_SCAN.monthly_salary_floor_k("月薪（含住房补贴）10-15K"), 10)
        self.assertAlmostEqual(
            CHINA_SCAN.monthly_salary_floor_k("日薪1000元/天，2-3K/月的住房补贴"),
            21.75,
        )
        self.assertAlmostEqual(
            CHINA_SCAN.monthly_salary_floor_k("日薪1000元/天，2-3K/月（住房补贴）"),
            21.75,
        )
        self.assertAlmostEqual(
            CHINA_SCAN.monthly_salary_floor_k("日薪1000元/天，2-3K/月(作为绩效奖金)"),
            21.75,
        )
