...
| Job Board Aggregator daily ATS dataset | Feashliaa/job-board-aggregator | Planned | Add its current manifest/chunk feed or run a licensed local subset; filter before downloading full million-job corpus. Confirm data URL and preserve CC BY-NC attribution. |
