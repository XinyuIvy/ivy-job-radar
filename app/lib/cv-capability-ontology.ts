...
const concepts: CapabilityConcept[] = [
  { id: "statistics", en: "statistics", zh: "统计学", aliasesZh: ["统计背景", "统计专业"] },
  { id: "biostatistics", en: "biostatistics", zh: "生物统计学", aliasesZh: ["生物统计"] },
  { id: "stem_field", en: "STEM field", zh: "理工科相关专业", aliasesZh: ["STEM 专业", "理工类专业", "数学统计相关专业"] },
  ...
  { id: "interdisciplinary_research", en: "interdisciplinary research", zh: "交叉学科研究", aliasesZh: ["跨学科研究", "交叉学科背景", "跨学科合作"] },
...
export const CV_JD_RULES: RequirementRule[] = [
  { label: "Education credential", category: "Education", aliases: ["phd", "ph.d.", "doctorate", "doctoral degree", "博士", "硕士", "学士", "本科", "统计学背景", "统计背景"], projectTerms: ["biostatistics", "statistics", "quantitative field", "生物统计", "统计学", "定量专业"] },
  { label: "STEM research domain", category: "Domain", aliases: ["stem", "理工类科研领域", "理工类科研", "自然科学科研", "理工科科研"], projectTerms: ["neuroimaging", "biomedical", "医学影像", "神经影像", "生物医学"] },
