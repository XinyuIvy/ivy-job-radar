...
const concepts: CapabilityConcept[] = [
  ...
  { id: "computer_science", en: "computer science", zh: "计算机" },
  { id: "artificial_intelligence_field", en: "artificial intelligence", zh: "人工智能", aliasesZh: ["AI"] },
  { id: "information_science", en: "information science", zh: "信息科学", aliasesZh: ["信息"] },
  { id: "mathematics", en: "mathematics", zh: "数学" },
  { id: "automation_field", en: "automation", zh: "自动化" },
...
export const CV_JD_RULES: RequirementRule[] = [
  ...
  { label: "Statistics background", category: "Education", aliases: ["statistics", "statistics background", "statistical background", "统计学", "统计学背景", "统计背景", "统计学专业", "统计专业"], projectTerms: ["biostatistics", "statistics", "生物统计", "统计学"] },
  { label: "Computer science background", category: "Education", aliases: ["computer science", "计算机"] },
  { label: "AI background", category: "Education", aliases: ["artificial intelligence", "ai background", "人工智能", "AI"] },
  { label: "Information science background", category: "Education", aliases: ["information science", "信息科学", "信息"] },
  { label: "Mathematics background", category: "Education", aliases: ["mathematics", "math background", "数学"] },
  { label: "Automation background", category: "Education", aliases: ["automation", "自动化"] },
